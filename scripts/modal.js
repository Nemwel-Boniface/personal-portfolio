  ...
  <div class="popupcont">
      ...
      <div class="popupcontlangs">
        <ul>
          ...
          <li>${myFeaturedProject[0].bootstrap}</li>
          <li>${myFeaturedProject[0].ruby}</li>
        </ul>
      </div>
...
function loopdiv() {
  ...
  <div class="project">
           <div class="projectHeader">
             <h3>${myFeaturedProject[i].projectHeader}</h3>
           </div>
           <div class="projectBody">
             <p>
             ${myFeaturedProject[i].projectDesc}
             </p>
             <ul>
               <li class="projectHTML">
                 <ul>
                  <li>${myFeaturedProject[i].projectHtml}</li>
                 </ul>
               </li>
               <li class="projectBootstrap">
                 <ul>
                   <li>${myFeaturedProject[i].projectbootstrap}</li>
                 </ul>
               </li>
               <li class="projectRuby">
                 <ul>
                   <li>${myFeaturedProject[i].projectRuby}</li>
                 </ul>
               </li>
             </ul>
           </div>
           <div class="projectButton openProject">
             <button id="proj1" class="testbtnn" onClick="loopdiv()">${myFeaturedProject[i].projectButton}</button>
           </div>
      </div>`;
  }
}
